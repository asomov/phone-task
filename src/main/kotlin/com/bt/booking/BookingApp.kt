...
import com.bt.booking.config.ApplicationProperties
import com.bt.booking.config.CRLFLogConverter
...
class BookingApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<BookingApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(BookingApp::class.java)
